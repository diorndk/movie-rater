...
function Auth() {
    ...
    const [token, setToken] = useCookies(['mr-token']) //mr-token stands for movie rater token
    ...
    return (
        <div className="App">
            ...
            <div className="login-container">
                ...
                <input type="username" placeholder="username" value={username} onChange={ evt => setUsername(evt.target.value)}/><br/>
